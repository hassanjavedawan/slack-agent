			...
			>
				...
				<div style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
					...
					<div style={{ flex: 1, minWidth: 0 }}>
						...
						>
							<span
								style={{ fontSize: 13.5, fontWeight: 600, color: "#1D1C1D" }}
							>
								Rin
							</span>
							...
							<span
								style={{ fontSize: 11, color: "#A8A49E", marginLeft: "auto" }}
							>
								Today, 8:47 AM
							</span>
						</div>
			...
			>
				{[
					...
					},
					{
						...
						content: (
							<span key="b">
								We help scaling teams replace that hiring with AI employees that
								start on day one. Based on your stack, I put together a quick
								breakdown of where we could free up{" "}
					...
					},
					{
						delay: "1.8s",
						content:
							"Worth a 15-minute call? I have Thursday 2pm or Friday morning open.",
					},
				].map((p, i) => (
					<p
						key={i}
	...
	return (
		...
		>
			...
			>
				...
				<span style={{ marginLeft: "auto", fontSize: 10, color: "#A8A49E" }}>
					4 results
				</span>
			</div>
			<div style={{ flex: 1, overflowY: "auto" }}>
				{results.map((r, i) => (
					...
					>
						...
						>
							<span
								style={{ fontSize: 11, fontWeight: 600, color: "#1e6a8a" }}
							>
								{r.source}
							</span>
...
function SelfDrivenPanel() {
	const tasks = [
		{ label: "Draft Q2 board update", status: "Done", done: true },
		{
	...
	return (
		...
		>
			...
			>
				...
				<div style={{ marginLeft: "auto", fontSize: 10, color: "#A8A49E" }}>
					Self-assigned
				</div>
			</div>
			<div style={{ flex: 1 }}>
